...
/* harmony default export */ __webpack_exports__["default"] = ("<app-questions-and-answers></app-questions-and-answers>");
...
/* harmony import */ var _questions_and_answers_questions_and_answers_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./questions-and-answers/questions-and-answers.component */ "./src/app/questions-and-answers/questions-and-answers.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _questions_and_answers_questions_and_answers_component__WEBPACK_IMPORTED_MODULE_5__["QuestionsAndAnswersComponent"]
        ],
        imports: [
...
let QuestionsAndAnswersComponent = class QuestionsAndAnswersComponent {
    ...
    initializeQuestionnaireForm() {
        this.questionnaireForm = this.formBuilder.group({
            questions: this.formBuilder.array([this.formBuilder.group({
                    ...
                    answers: this.formBuilder.array([this.formBuilder.group({ answer: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required] })])
                })])
        });
    }
    get questionItems() {
    ...
    addAnswer(questionIndex) {
        this.questionItems.controls[questionIndex].get('answers').push(this.formBuilder.group({ answer: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required] }));
        if (this.isFormSubmitted) {
            this.isFormSubmitted = false;
        }
    }
    addQuestion() {
        this.questionItems.push(this.formBuilder.group({ question: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            answers: this.formBuilder.array([this.formBuilder.group({ answer: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required] })]) }));
        if (this.isFormSubmitted) {
            this.isFormSubmitted = false;
        }
...
QuestionsAndAnswersComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
QuestionsAndAnswersComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-questions-and-answers',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./questions-and-answers.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/questions-and-answers/questions-and-answers.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./questions-and-answers.component.scss */ "./src/app/questions-and-answers/questions-and-answers.component.scss")).default]
    })
...
module.exports = __webpack_require__(/*! D:\ROHIT\Projects\questions-and-answers\src\main.ts */"./src/main.ts");
